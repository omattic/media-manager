...
- Duplicate and protection grouping uses a portable metadata fingerprint based on file size and modified time. It is probable, not content-hash verification.
